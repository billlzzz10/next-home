# Craft – Multi-Document API for bl1nk_mcp_craft
...
- [https://connect.craft.do/links/2McInshMfLC/api/v1](https://connect.craft.do/links/2McInshMfLC/api/v1)
...
- **format** (query): string
  The format to return the schema in. Default: json-schema-items.
